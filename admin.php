    ...
    <script type="text/javascript">
         $(document).ready(function(){
             $("form").submit(function(e){
                 ...
                 $("#adminlogsub").text("Authenticating...");
                    $("#adminlogsub").addClass("authenticate");
                    $("#adminlogsub").removeClass("btn btn-success");
                     $(".spinner").css('display','inline-block');
                 var uid=$("#uid").val();
                var pswd=$("#pswd").val();
                 var adminlogsub=$("#adminlogsub").val();
                 $.post("valmemlogin.php",{
                    uid:uid,
                    pswd:pswd,
                     adminlogsub:adminlogsub
                 },function(data,status){
                     if(status == 'success')
                     {
                       $("#adminlogsub").text("Login Successful. Redirecting...");
                       $("#adminlogsub").addClass("bg-success");
                       $("#adminlogsub").css("color","white");
                       ...
                       if(data == uid)
                       {
                           ...
                           window.location.replace("admindshb.php?login=success&uid="+encuid);
                       }
                       else if(data != uid)
                       {
                           $("#lastinp").after(data);
        ...
        <div class="row d-flex" style="justify-content:center;align-items:center;height:750px;position:relative;top:calc(50% - 150px);">
            <div class="col-lg-3" id="memlogform">
                <div id="header" class="text-center">
                  <h5 style="color:#646464;">Admin Login</h5>
                </div>
                <form action="valmemlogin.php" method="POST">
                    <div class="form-group mt-4">
                        <input type="text" name="uid" id="uid" placeholder="User ID" class="form-control" pattern="[A-Z]+">
                    </div>
                    <span id="uidmsg"></span>
                    ...
                    <div class="form-group text-center mt-3">
                        <button type="submit" name="adminlogsub" id="adminlogsub" class="btn btn-success" style="padding:10px!important;">LOGIN<div class="spinner">
