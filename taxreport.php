                  ...
                  <div class="row">
                      <div class="col-lg-12" id="reportbox">
                         <div id="header" class="mb-3">
                             <h5 style="color:#646464;">Tax Report</h5>
                         </div>
             <div class="table-responsive">
              <table class="display table-bordered">
                ...
                $sql="select * from member;";
                    ...
                    while($row=mysqli_fetch_assoc($result))
                    {
                        $curdt=date("d-m-Y");
                         ...
                         else if($diff < 7 and $row['FinishedReview'] == NULL)
                         {
                             $bonus=$row['Bonus'];
                                         $totamt=$row['PairCommission']+$bonus;
                                          $tdstax=0.04*$totamt;
                ...
                //Display Data
                    ...
                    {
                        $getinv="select distinct(CGST,SGST,IGST) from invoice where Invto='".$memrow['MemberID']."';";
                        $invres=mysqli_query($connection,$getinv);
                        while($invrow=mysqli_fetch_assoc($invres))
                        {
                         echo '<tr>
                          <td>'.$i.'</td>
